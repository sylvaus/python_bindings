...
SWIGINTERN PyObject *_wrap_plus_two_list(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = swig::asptr(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "plus_two_list" "', argument " "1"" of type '" "std::vector< int,std::allocator< int > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "plus_two_list" "', argument " "1"" of type '" "std::vector< int,std::allocator< int > > const &""'"); 
    }
    arg1 = ptr;
  }
  result = plus_two_list((std::vector< int,std::allocator< int > > const &)*arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "plus_two_list", _wrap_plus_two_list, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
