...
/*-----------------------------------------------
              @(target):= _constants.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__constants

#else
#  define SWIG_init    init_constants

#endif
#define SWIG_name    "_constants"
...
SWIGINTERN PyObject *CONST_STRING_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args, "swigconstant", 1, 1, &module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "CONST_STRING",SWIG_From_std_string(static_cast< std::string >(CONST_STRING)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *PRIME_NUMBERS_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args, "swigconstant", 1, 1, &module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "PRIME_NUMBERS",swig::from(static_cast< std::vector< int,std::allocator< int > > >(PRIME_NUMBERS)));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "CONST_STRING_swigconstant", CONST_STRING_swigconstant, METH_O, NULL},
	 { "PRIME_NUMBERS_swigconstant", PRIME_NUMBERS_swigconstant, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "PI",SWIG_From_double(static_cast< double >(PI)));
  SWIG_Python_SetConstant(d, "CONST_RAW_STRING",SWIG_FromCharPtr(CONST_RAW_STRING));
